...
> **TL;DR —** 本研究的三層核心成果：
>
> - **痛點**：長序列 LLM 面臨 KV Cache 記憶體牆（$O(N)$ 線性成長）與 MoE 權重體積牆（$E$ 倍 dense 膨脹）。
...
### 9.8 邊緣設備應用展示：即時桌面 AI 助手（Edge Application: Real-Time On-Device AI Assistant）
